/* For the peripherals such as CI/CA devices, please check the hardware circuit, if there are
     no CI/CA circuit,Please disable CI/CA macro,don't attach CA/CI drivers.
     SMC1_SUPPORT: enable smart card 1 interface.
    SMC2_SUPPORT: enable smart card 2 interface.
    CI_SUPPORT:   enable CI interface.
*/
...
#define SMC1_SUPPORT
#define SYS_MAIN_BOARD BOARD_DB_M3712L_01V01
#elif defined _BOARD_DB_M3721L_01V01_
#define SYS_MAIN_BOARD BOARD_DB_M3721L_01V01
#define SMC1_SUPPORT
#ifdef _AUI_
//#define SUPPORT_TWO_TUNER
#endif
#elif defined _BOARD_DB_M3721_02V01_
#define SYS_MAIN_BOARD BOARD_DB_M3721_02V01
#define SMC1_SUPPORT
//#define SUPPORT_TWO_TUNER
#elif defined _BOARD_DB_M3729_01V01_
    #define SYS_MAIN_BOARD BOARD_DB_M3729_01V01 
    #define SUPPORT_TWO_TUNER
#else
#ifdef AUI
#else
...
#define HDCP2_SUPPORT
#define USE_V20COMPLIANT_V21
#define ALICAST_SUPPORT
//#undef WIFI_DIRECT_SUPPORT
#endif
...
#if (defined _BOARD_DB_M3712L_01V01_)
#define STANDBY_PAN_SDA_PIN (193)
#define STANDBY_PAN_SCL_PIN (192)
#else
#define STANDBY_PAN_SDA_PIN (193)
#define STANDBY_PAN_SCL_PIN (192)
#endif
...
/*If macro 'PMU_ENABLE' is disabled, cpu standby solution will be enabled.*/
#define PMU_ENABLE
#ifndef PMU_ENABLE
...
//#define AFD_SW_SUPPORT
//#define AFD_HW_SUPPORT
#define MP_PREVIEW_SWITCH_SMOOTHLY  //default enable it for unify see memory map
//#define CHANCHG_VIDEOTYPE_SUPPORT
#endif
...
#define SYS_CPU_MODULE                CPU_MIPS74KF//CPU_MIPS24KE
...
//3702 flash base is differ with other chip
#define SYS_FLASH_BASE_ADDR             0xbfc00010//0xbfc00000
#else
...
//#ifdef AUI
#if 0  //not need this for 3702 by steven.zhang
...
*/
    ...
    #endif
#endif
#if ((defined(_GEN_CA_ENABLE_)||defined (_C1800A_CA_ENABLE_))&&(!defined(_SAT2IP_SERVER_ENABLE_)))
...
// We have to ensure network is enable when compile nestor 
...
//memory optimization
#define OSD2_DISABLE
#define EPG_BUFF_DISABLE

#define HEVC_DISABLE               //remove all hevc buffer
//#define HEVC_8BIT_MODE        //8bit HEVC mode, reduce HEVC buffer from 0x2020000(For 10 Bit ) to 0x1820000 (For 8 Bit)   //(8MB)

#define  DVIEW_DISABLE                 //remove  DVIEW BUFFER  (5.3MB)
//#define DUAL_OUTPUT_DISABLE      //remove Dual video outout vcap buffer (3.2MB)
 #define PVR_SIZE_REDUCE             //Reduce PVR buffer size to 0x930000 ,same as M3626 (4.22MB )
#ifdef DVBC_SUPPORT     
 #define J83B_QAM_BUFFER_DISABLE        //  Reduce J83B NIM Buffer from 2MB to 256KB (malloc from heap)
#endif 
...
#define CC_ON 0
#define SUBTITLE_ON 0
#undef SYS_OS_MUTX_NUM
#define SYS_OS_MUTX_NUM   1024
#define PAN_DIRECT_GPIO
#define SUPPORT_FIRMWARE_CONFIG
#endif


#ifdef DVIEW_DISABLE
#if defined(MP_PREVIEW_SWITCH_SMOOTHLY)
#undef MP_PREVIEW_SWITCH_SMOOTHLY
#endif
#endif

//Remove DUAL_OUTPUT
#ifdef DUAL_OUTPUT_DISABLE
