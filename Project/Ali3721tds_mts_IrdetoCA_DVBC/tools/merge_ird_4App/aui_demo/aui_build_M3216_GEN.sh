...
build_main_config()
{
	...
	option_select "enable" "_BOARD_M3712_01V01_ = 1" ${COMPILER_DEF}
	...
	option_select "enable" "_SD_ONLY_ = 1" ${COMPILER_DEF}
	option_select "enable" "_USE_64M_MEM_ = 1" ${COMPILER_DEF}
...
backup_firmware()
{
	...
	cp ${PROJECT_ROOT}/obj/product_sabbat_dual.abs ${PROJECT_ROOT}/images/product_sabbat_dual_aui_m3216_gen.abs
	check_previous_return_val
}
