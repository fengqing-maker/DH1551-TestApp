/**
 * $Id: s3_status.h,v 1.53 2010/01/27 23:59:30 sren Exp $.
 *
...
typedef enum
{
	...
	SOURCE_SVC_CI_PLUS_PVR_RECORD      = 63,   /* CI PLUS PVR service */
	SOURCE_MOD_CI_PLUS_PVR_ECM	= 64,	/* CI PVR ECM source (PMT) module. */
	SOURCE_MOD_SESSION_MANAGEMENT_CCA_METADATA  = 65 /* DRM Session Management resource module. */
} ia_status_source_e;
