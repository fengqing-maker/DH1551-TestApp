/*
 * $Id: s3_vd_copycontrol.h,v 1.6 2009/05/04 06:28:50 dfu Exp $
 *
...
#define URI_MESSAGE_LENGTH	 	8
#define PROTOCOL_VERSION_OFFSET 0
#define EMIAPSICT_OFFSET	 	1
#define RL_OFFSET	 			2


typedef struct
{	
	ia_byte					bURIMessage[ URI_MESSAGE_LENGTH ];
} vd_copycontrol_uri_cci_st;
