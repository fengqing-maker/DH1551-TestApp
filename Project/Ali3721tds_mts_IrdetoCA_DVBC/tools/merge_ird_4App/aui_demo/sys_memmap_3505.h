...
#endif
#ifndef AD_MV_SHARE_BUFFER //MULTIVIEW_SUPPORT
...
#define __MM_PRIV_DEC_ADDR (__MM_VOID_BUFFER_ADDR - __MM_PRIV_DEC_LEN)
#else
#define __MM_PRIV_DEC_LEN   0
#define __MM_PRIV_DEC_ADDR  0
#endif

//#define __MM_FB_TOP_ADDR        __MM_VOID_BUFFER_ADDR    //64MB
#define __MM_FB_TOP_ADDR        (__MM_VOID_BUFFER_ADDR - __MM_PRIV_DEC_LEN)    //64MB
...
#define AVC_MB_NEI_LEN        0xf000//0x20000
...
#define __MM_OSD1_LEN           (1280*720*4)//(1280*720*2 + 256)//(1008 * 640 * 2  + 256)//(1280*720*2 + 256) //(1280*720*4)
...
#define __MM_OSD_BK_ADDR2       ((__MM_EPG_BUFFER_START - __MM_OSD2_LEN)&0XFFFFFFE0)
...
#define __MM_GE_LEN                (__MM_GMA1_LEN+__MM_GMA2_LEN+__MM_TEMP_BUF_LEN+__MM_CMD_LEN) //0xBE45B0
#define __MM_OSD_LEN            0x65400 // 720*576
#define __MM_OSD1_LEN           (1280*720*4)//(1280*720*2 + 256) //(1280*720*4)
#define __MM_OSD2_LEN            (1920*1080)
...
#define __MM_SHARED_MEM_LEN      1024
    ...
    #else
		#define __MM_PRIVATE_SHARE_LEN	0x01700000//0x02000000//0x01e00000	//30M
...
/************************************************************PVR BUFFER LEN*********************************************************/
    ...
    #define MHEG5_MEMORY_ALLOC_REGION_SIZE        0X800000
        ...
        #define __MM_PVR_VOB_BUFFER_LEN        ((47*1024)*(75*2)+0x1000- __MM_NIM_BUFFER_LEN)//0x88a800//0x6fb000
			...
			#define __MM_PVR_VOB_BUFFER_LEN (((47*1024)*(150*3)+0x1000) - __MM_MEDIA_PROV_BUFFER_LEN - __MM_DLNA_BUFFER_LEN - __MM_NIM_BUFFER_LEN - (5*1024*1024))
			#else
			#define __MM_PVR_VOB_BUFFER_LEN (((47*1024)*(160*3)+0x1000) - __MM_MEDIA_PROV_BUFFER_LEN - __MM_DLNA_BUFFER_LEN - __MM_NIM_BUFFER_LEN)
			#endif
		#else
			#ifdef _NESTOR_SUPPORT_
			#define __MM_PVR_VOB_BUFFER_LEN (((47*1024)*(150*3)+0x1000) - __MM_MEDIA_PROV_BUFFER_LEN - __MM_NIM_BUFFER_LEN - __MM_DMX_MAIN_BLK_LEN -(5*1024*1024))
			#else
...
#ifdef SD_PVR
    #define __MM_MAIN_TOP_ADDR      0xa2600000//38MB
    #define __MM_FB_TOP_ADDR        __MM_MAIN_TOP_ADDR
#else
	#ifdef HW_SECURE_ENABLE
		//gen 
		#define __MM_FB_TOP_ADDR        0xa6900000		//105MB
	#else
		//ret
...
#define __MM_DMX_SEE_BLK_ADDR    ((HEVC_CMD_QUEUE_BUF_ADDR - __MM_DMX_BLK_BUF_LEN)&0XFFFFFFE0)
#else
...
#else
    #define __MM_MAIN_TOP_ADDR      0xa6900000//0xa6000000        //96MB
...
#define __MM_DMX_SEE_BLK_ADDR       ((VDEC_PRIVATE_START_ADDR - __MM_DMX_BLK_BUF_LEN)&0XFFFFFFE0)
#define __MM_DMX_SEE_BLK_START_ADDR (__MM_DMX_SEE_BLK_ADDR)
...
#define __MM_PRIVATE_ADDR        (__MM_PRIVATE_TOP_ADDR-__MM_PRIVATE_LEN)     //96M
    ...
    #define __MM_DMX_AVP_START_ADDR     ((__MM_OSD_VSRC_MEM_ADDR - __MM_SI_VBV_OFFSET - __MM_DMX_DATA_LEN - __MM_DMX_AVP_LEN)&0XFFFFFFFC)
...
#define __MM_HEAP_TOP_ADDR      __MM_DBG_MEM_ADDR
#else
#define __MM_HEAP_TOP_ADDR      (0xb0000000-1)
#endif
