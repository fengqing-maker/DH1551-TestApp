...
build_main_config()
{
	...
	option_select "enable" "_BOARD_M3727_02V01_ = 1" ${COMPILER_DEF}
...
backup_firmware()
{
	...
	cp ${PROJECT_ROOT}/obj/product_sabbat_dual.abs ${PROJECT_ROOT}/images/product_sabbat_dual_aui_m3727_02v01_cnx.abs
	check_previous_return_val
}
