...
#if(SYS_MAIN_BOARD == BOARD_DB_M3606_01V01 || SYS_MAIN_BOARD == BOARD_DB_M3603_01V01)
...
//#define CI_PLUS_SUPPORT
    ...
    //GXX no Mg license
    #define CI_NO_MG     /* @Should be enable always */
...
#define __MM_SHARED_MEM_LEN      256
    ...
    #define __MM_SEE_MP_BUF_LEN      0x00000000    //0M
...
#define __MM_TTX_P26_DATA_LEN       0
    ...
    #define __MM_PVR_VOB_BUFFER_LEN        0x600000 // ((47*1024)*(240*3)+0x1000)
...
#define __MM_USB_START_ADDR            ((__MM_DMX_CPU_BLK_ADDR - __MM_USB_DMA_LEN)&0XFFFFFFE0)
...
#define AVC_CMD_QUEUE_ADDR  ((__MM_DMX_SEE_BLK_ADDR - AVC_CMD_QUEUE_LEN)&0xffffff00)      //256 bytes alignment
