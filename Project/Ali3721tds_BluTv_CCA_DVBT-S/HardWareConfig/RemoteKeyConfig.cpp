...
static ADIIRDecode_S g_sIrDecode_BluTv[] = 
{
	{0x12,	ADI_VK_POWER,	  ADI_TRUE},
	{0x10,  ADI_VK_MAIL_INFO,     ADI_TRUE},	
	{0x5B,  ADI_VK_OK,    ADI_TRUE},
	
	{0x49,	ADI_VK_MENU,		  ADI_TRUE},
	{0x47,	ADI_VK_MUTE,	  ADI_TRUE},

	{0x1B,  ADI_VK_UP,        ADI_TRUE},
	{0x1F,  ADI_VK_DOWN,      ADI_TRUE},
	{0x1E,  ADI_VK_LEFT,      ADI_TRUE},
	{0x1A,  ADI_VK_RIGHT,     ADI_TRUE},

	{0x00,  ADI_VK_0,         ADI_TRUE},
	{0x01,  ADI_VK_1,         ADI_TRUE},
	{0x02,  ADI_VK_2,         ADI_TRUE},
	{0x03,  ADI_VK_3,         ADI_TRUE},
	{0x04,  ADI_VK_4,         ADI_TRUE},
	{0x05,  ADI_VK_5,         ADI_TRUE},
	{0x06,  ADI_VK_6,         ADI_TRUE},
	{0x07,  ADI_VK_7,         ADI_TRUE},
	{0x08,  ADI_VK_8,         ADI_TRUE},
	{0x09,  ADI_VK_9,         ADI_TRUE},
	
	{0x13,  ADI_VK_CHANNEL_UP,         ADI_TRUE},
	{0x14,  ADI_VK_CHANNEL_DOWN,         ADI_TRUE},
	{0x4B,  ADI_VK_VOLUME_UP,         ADI_TRUE},
	{0x4A,  ADI_VK_VOLUME_DOWN,         ADI_TRUE},

	{0x51,  ADI_VK_PAGE_UP,         ADI_TRUE},
	{0x48,  ADI_VK_RW,         ADI_TRUE},
	{0x1C,  ADI_VK_FF,         ADI_TRUE},
	{0x18,  ADI_VK_PAGE_DOWN,         ADI_TRUE},

	{0x5D,  ADI_VK_STOP,         ADI_TRUE},
	{0x54,  ADI_VK_PAUSE,         ADI_TRUE},
	{0x0D,  ADI_VK_FORWARD,         ADI_TRUE},
	{0x19,  ADI_VK_RECORD,         ADI_TRUE},

	{0x46,  ADI_VK_COLORED_KEY_0,         ADI_TRUE},
	{0x42,  ADI_VK_COLORED_KEY_1,         ADI_TRUE},
	{0x56,  ADI_VK_COLORED_KEY_2,         ADI_TRUE},
	{0x5A,  ADI_VK_COLORED_KEY_3,         ADI_TRUE},

	{0x16,  ADI_VK_GUIDE,         ADI_TRUE},
	{0x15,  ADI_VK_INFO,         ADI_TRUE},
	{0x11,  ADI_VK_EXIT,         ADI_TRUE},
	{0x40,  ADI_VK_SERV,         ADI_TRUE},

	{0x41,  ADI_VK_FAV,         ADI_TRUE},
	{0x17,  ADI_VK_SCROLL_LOCK,         ADI_TRUE},
};
...
static ADIIREquipList_S g_sIrEquipList_BluTv = 
{
	EM_ADIIR_PROTOCOL_NEC,
	0x5A04,
	sizeof(g_sIrDecode_BluTv)/sizeof(ADIIRDecode_S),
	g_sIrDecode_BluTv
};
...
void MSAppIrInit()
{
	...
	ADIIRAddEquipment(&g_sIrEquipList_BluTv, &hIRHandle);
}
