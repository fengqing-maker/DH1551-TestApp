/**
 * $Id: s3_hgpc_msg.h,v 1.6 2010/04/06 08:04:17 pnarewski Exp $
 *
...
{
	msg_hgpc_method_e				eMethod;
	ia_word32						wHNRTimeLeft;
	ia_word16						wActivationCode;
	msg_hgpc_smartcard_id_st	stPrimCardId;
} msg_hgpc_card_v2_secondary_st;
...
typedef struct
{
	msg_hgpc_method_e				eMethod;
	ia_word32						wHNRTimeLeft;
	ia_word32						wHNATimeLeft;
	ia_word16						wActivationCode;
	msg_hgpc_smartcard_id_st	stPrimCardId;
} msg_hgpc_card_v21_secondary_st;
...
/* Fixed TFS#19726: Secondary SoftCell shall provide the expiry reminder for the inserted secondary cards. */
typedef struct
{
	vd_rsc_id			wResourceId;
	/* Fixed TFS#19872: Extend the HNR reminder time from 1 byte to 2 bytes. */
	ia_word16			wExpiryReminder;
} msg_hgpc_expiry_reminder_config_st;
...
typedef enum
{
	...
	HGPC_EVENT_HNR_EXPIRY_REMINDER,
	HGPC_EVENT_HNA_EXPIRY_REMINDER
