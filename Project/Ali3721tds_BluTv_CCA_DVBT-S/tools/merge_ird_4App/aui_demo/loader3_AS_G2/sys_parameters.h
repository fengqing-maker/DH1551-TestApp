...
*/
#ifndef _SYS_PARAMETERS_
#define _SYS_PARAMETERS_

/* Chunk ID */
#define BOOT_ID_2               0xE3000010
#if defined(BL_C0300A_AS) || defined(BL_C0300A_STD)
...
#define CHUNKID_UBOOT_BAK       0x11EE0101
#define CHUNKID_KEY_OFFSET 0x350000
#define CHUNKID_KEY_SEE         0x23DC0100

#define CHUNKID_STBINFO         0x20DF0100
#define CHUNKID_STBINFO_MASK 0xFFFF0000
#define CHUNKID_LOGO          0x02FD0100
#define CHUNKID_LOGO_MASK     0xFFFF0000
#define CHUNKID_MEM_CFG       0x07F80100
#define CHUNKID_MEM_CFG_MASK  0xFFFF0000
