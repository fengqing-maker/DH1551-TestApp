...
unsigned char  tempbuf[340 * 1024];
int _tmain(int argc, _TCHAR* argv[])
{
	...
	if(nLen>340*1024)
	{
		memcpy(tempbuf, outbuf + 340 * 1024, nLen - 340 * 1024);
		memset(outbuf + 340 * 1024, 0xff, nLen - 340 * 1024);
		memcpy(outbuf + 6 * 64 * 1024, tempbuf, 340 * 1024);
	}
