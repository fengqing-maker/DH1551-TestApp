/**
 * $Id: s3_smartcard.h,v 1.30 2010/01/27 23:57:24 sren Exp $
 *
...
{
	vd_rsc_id	wResourceId;
} msg_ci_plus_ca_pvr_info_query_st;

typedef struct
{
	vd_rsc_id	wResourceId;
	ia_byte		bPvrInfoCount;
} msg_ci_plus_ca_pvr_info_reply_st;


typedef struct
{
	ia_word16	wcaSystemId;
	ia_byte		bCaModeRecording;
} msg_ci_plus_ca_pvr_info_st;
